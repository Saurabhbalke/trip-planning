...
<body>
    ...
    <h1 class="p-4 center">Edit Tourist places details</h1>
    <div class="container box p-4 shadow bg-white">
        <div class="insert  border  ">
            <article class="heading p-2">
                <h2>Tourist Places Registration Form</h2>
            </article>
            <div class="container ">

                <form action="edit_tourist_place.php" method="post">
                    <div>
                        <label>
                            <h6>Place id</h6>
                        </label>
                    ...
                    die('Failed to connect to server: ');
                        ...
                        echo
                        '<select class=" border p-1 col-4 rounded"  name="did" >
                    ...
                    <div>
                        <label>
                            <h6>Nearby Tourist Places</h6>
                        </label> 
                        <br>
                        <input type="text" name="add" class="rounded border">
                    </div>
                    <div>
                        <label>
                        ...
                        <br>
                        <input type="text" name="te" class="rounded border">
                    ...
                    <div>
                        ...
                        <br>
                        <input type="text" name="fe" class="rounded border">
        ...
        <div class="insert  border  ">
            <article class="heading p-2">
                <h2>Update / Delete Tourist Places</h2>
            </article>
            <div class="container my-2 ">
                ...
                <form action="edit_tourist_place.php" method="post">
                    ...
                    die('Failed to connect to server: ');
                        ...
                        <option value="" >Choose place id</option>';
                        
                        $qry= "SELECT t_id FROM tourist_place";
                        $result = mysqli_query($link, $qry);
                        while($row = mysqli_fetch_assoc($result))
                        {
