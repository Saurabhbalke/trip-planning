...
<body>
    ...
    <h1 class="p-4 center">Edit Starting details</h1>
    <div class="container box p-4 shadow bg-white">
        <div class="insert  border  ">
            <article class="heading p-2">
                <h2>Insert Starting location</h2>
            </article>
            <div class="container ">

                <form action="edit_curr_loc.php" method="post">
                    <div>
                        <label>
                            <h6>City id</h6>
                        </label>
        ...
        <div class="insert  border  ">
            <article class="heading p-2">
                <h2>Update / Delete Starting location</h2>
            </article>
